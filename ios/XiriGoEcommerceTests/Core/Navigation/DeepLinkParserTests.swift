...
struct DeepLinkParserTests {
    ...
    func parse_xgProductScheme_returnsProductDetail() throws {
    ...
    func parse_xgProductNumericId_returnsProductDetail() throws {
    ...
    func parse_xgProductMissingId_returnsNil() throws {
    ...
    func parse_xgCategoryScheme_returnsCategoryProducts() throws {
    ...
    func parse_xgCategoryMissingId_returnsNil() throws {
    ...
    func parse_xgCart_returnsCart() throws {
    ...
    func parse_xgOrderScheme_returnsOrderDetail() throws {
    ...
    func parse_xgOrderMissingId_returnsNil() throws {
    ...
    func parse_xgProfile_returnsProfile() throws {
    ...
    func parse_httpsProductUniversalLink_returnsProductDetail() throws {
    ...
    func parse_httpsProductMissingId_returnsNil() throws {
    ...
    func parse_httpsCategoryUniversalLink_returnsCategoryProducts() throws {
    ...
    func parse_httpsCategoryMissingId_returnsNil() throws {
    ...
    func parse_xgUnknownHost_returnsNil() throws {
    ...
    func parse_httpsUnknownPath_returnsNil() throws {
    ...
    func parse_httpsEmptyPath_returnsNil() throws {
    ...
    func parse_httpsDifferentHost_returnsNil() throws {
    ...
    func parse_httpScheme_returnsNil() throws {
    ...
    func parse_ftpScheme_returnsNil() throws {
    ...
    func parse_xgProductEmptyId_returnsNil() {
        // URL with trailing slash creates empty path component — parser should handle
        guard let url = URL(string: "xirigo://product/") else {
            return
        }
        let route = DeepLinkParser.parse(url)
        // pathComponents.filter { $0 != "/" } on "xirigo://product/" may yield [] or [""]
        // Either way, an empty productId should result in nil
        if let result = route, case let .productDetail(id) = result {
            #expect(!id.isEmpty, "productId must not be empty")
        }
    }

    @Test("xirigo://order with empty string id returns nil")
    func parse_xgOrderEmptyId_returnsNil() {
        guard let url = URL(string: "xirigo://order/") else {
            return
        }
        let route = DeepLinkParser.parse(url)
        if let result = route, case let .orderDetail(id) = result {
            #expect(!id.isEmpty, "orderId must not be empty")
        }
    }

    @Test("xirigo://category with empty string id returns nil")
    func parse_xgCategoryEmptyId_returnsNil() {
        guard let url = URL(string: "xirigo://category/") else {
            return
        }
        let route = DeepLinkParser.parse(url)
        if let result = route, case let .categoryProducts(id, _) = result {
    ...
    func parse_xgOrder_routeRequiresAuth() throws {
    ...
    func parse_xgProduct_routeDoesNotRequireAuth() throws {
    ...
    func parse_xgCart_routeDoesNotRequireAuth() throws {
        let url = try #require(URL(string: "xirigo://cart"))
        let route = DeepLinkParser.parse(url)
        #expect(route?.requiresAuth == false)
    }
    ...
    func parse_xgProfile_routeDoesNotRequireAuth() throws {
        let url = try #require(URL(string: "xirigo://profile"))
        let route = DeepLinkParser.parse(url)
        #expect(route?.requiresAuth == false)
    }
    ...
    func parse_httpsProduct_routeDoesNotRequireAuth() throws {
    ...
    func parse_httpsCategory_routeDoesNotRequireAuth() throws {
    ...
    func parse_noScheme_returnsNil() {
    ...
    func parse_xgProductExtraSegments_parsesFirstSegment() throws {
