...
struct MedusaErrorDTOTests {
    ...
    func decode_fullError_withTypeMessageAndCode() throws {
        let json = Data("""
            {
                "type": "not_found",
    ...
    func decode_partialError_withoutCode_codeIsNil() throws {
        let json = Data("""
            {
                "type": "unauthorized",
    ...
    func decode_errorWithNullCode_codeIsNil() throws {
        let json = Data("""
            {
    ...
    func decode_malformedJSON_missingRequiredFields_throwsError() throws {
        let json = Data("""
            {
                "type": "not_found"
            }
    ...
    func decode_invalidJSON_throwsError() throws {
    ...
    func decode_emptyJSON_throwsError() throws {
        let json = Data("{}".utf8)
    ...
    func init_allFields_areStoredCorrectly() {
    ...
    func init_withoutCode_codeIsNil() {
    ...
    func decode_invalidDataType_isDecodedCorrectly() throws {
        let json = Data("""
            {
                "type": "invalid_data",
    ...
    func decode_rateLimitError_isDecodedCorrectly() throws {
        let json = Data("""
            {
                "type": "rate_limit",
