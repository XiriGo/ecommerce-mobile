...
struct RetryPolicyTests {
    ...
    func delay_attempt0_isWithinBaseDelayJitterBounds() {
    ...
    func delay_attempt1_isWithinTwoSecondJitterBounds() {
        let policy = RetryPolicy.default
    ...
    func delay_attempt2_isWithinFourSecondJitterBounds() {
        let policy = RetryPolicy.default
    ...
    func delay_largeAttempt_isClampedAtMaxDelay() {
        let policy = RetryPolicy.default
    ...
    func delay_allAttempts_isPositive() {
        let policy = RetryPolicy.default
        for attempt in 0 ..< 10 {
            for _ in 0 ..< 5 {
    ...
    func delay_zeroJitter_attempt0_equalsBaseDelay() {
    ...
    func delay_zeroJitter_attempt1_equalsTwoTimesBase() {
        let policy = RetryPolicy(
            maxRetries: 3,
            baseDelay: 1.0,
            backoffMultiplier: 2.0,
    ...
    func delay_zeroJitter_attempt2_equalsFourTimesBase() {
        let policy = RetryPolicy(
            maxRetries: 3,
            baseDelay: 1.0,
            backoffMultiplier: 2.0,
    ...
    func delay_zeroJitter_highAttempt_isClampedAtMaxDelay() {
        let policy = RetryPolicy(
            maxRetries: 3,
            baseDelay: 1.0,
            backoffMultiplier: 2.0,
    ...
    func customPolicy_customStatusCodes_onlyThoseAreRetryable() {
        let policy = RetryPolicy(
            maxRetries: 2,
            baseDelay: 0.5,
