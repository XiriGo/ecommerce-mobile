...
struct PaginatedResponseTests {
    ...
    func hasMore_offsetPlusLimitLessThanCount_returnsTrue() {
    ...
    func hasMore_middlePage_returnsTrue() {
    ...
    func hasMore_lastFullPage_returnsFalse() {
    ...
    func hasMore_countEqualsLimit_returnsFalse() {
    ...
    func hasMore_countLessThanLimit_returnsFalse() {
    ...
    func hasMore_oneMoreItemRemains_returnsTrue() {
    ...
    func hasMore_lastItemExactlyAtEnd_returnsFalse() {
        // offset=0, limit=20, count=20 → 0+20=20 >= 20 → hasMore = false
        let meta = PaginationMeta(count: 20, limit: 20, offset: 0)
        #expect(meta.hasMore == false)
    }
    ...
    func decode_validJSON_isDecodedCorrectly() throws {
        let json = Data("""
            {
                "count": 142,
                "limit": 20,
    ...
    func decode_lastPage_hasMoreIsFalse() throws {
        let json = Data("""
            {
                "count": 142,
                "limit": 20,
    ...
    func equatable_differentCount_areNotEqual() {
        let metaA = PaginationMeta(count: 50, limit: 20, offset: 0)
