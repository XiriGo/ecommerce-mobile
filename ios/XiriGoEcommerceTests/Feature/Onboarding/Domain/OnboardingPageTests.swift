...
struct OnboardingPageTests {
    ...
    func test_comparePage_hasCorrectIllustrationName() {
    ...
    func test_checkoutPage_hasCorrectIllustrationName() {
    ...
    func test_trackPage_hasCorrectIllustrationName() {
    ...
    func test_equalityCheck_samePagesAreEqual() {
    ...
    func test_equalityCheck_differentPagesAreNotEqual() {
        let page1 = OnboardingPage.allPages[0]
    ...
    func test_allPages_haveUniqueIds() {
        let ids = OnboardingPage.allPages.map(\.id)
