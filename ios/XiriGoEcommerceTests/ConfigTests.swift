...
struct ConfigTests {
    ...
    func apiBaseURLIsValid() {
        ...
        #expect(url.host()?.hasSuffix("xirigo.com") == true)
    }
    ...
    func apiBaseURLStaging() {
        #if STAGING
        #expect(Config.apiBaseURL.absoluteString == "https://api-staging.xirigo.com")
        #endif
    }
    ...
    func apiBaseURLRelease() {
        #if !DEBUG && !STAGING
        #expect(Config.apiBaseURL.absoluteString == "https://api.xirigo.com")
        #endif
    }
