...
struct DeepLinkParserTests {
    ...
    func test_parse_moltProductScheme_returnsProductDetail() {
        let url = URL(string: "molt://product/prod_abc")!
        let route = DeepLinkParser.parse(url)
        #expect(route == .productDetail(productId: "prod_abc"))
    }

    @Test("molt://product/{id} with numeric id parses to productDetail")
    func test_parse_moltProductNumericId_returnsProductDetail() {
        let url = URL(string: "molt://product/12345")!
        let route = DeepLinkParser.parse(url)
        #expect(route == .productDetail(productId: "12345"))
    }

    @Test("molt://product with missing id returns nil")
    func test_parse_moltProductMissingId_returnsNil() {
        let url = URL(string: "molt://product")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }
    ...
    func test_parse_moltCategoryScheme_returnsCategoryProducts() {
        let url = URL(string: "molt://category/cat_fashion")!
        let route = DeepLinkParser.parse(url)
        #expect(route == .categoryProducts(categoryId: "cat_fashion", categoryName: ""))
    }

    @Test("molt://category with missing id returns nil")
    func test_parse_moltCategoryMissingId_returnsNil() {
        let url = URL(string: "molt://category")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }
    ...
    func test_parse_moltCart_returnsCart() {
    ...
    func test_parse_moltOrderScheme_returnsOrderDetail() {
        let url = URL(string: "molt://order/ord_xyz")!
        let route = DeepLinkParser.parse(url)
        #expect(route == .orderDetail(orderId: "ord_xyz"))
    }

    @Test("molt://order with missing id returns nil")
    func test_parse_moltOrderMissingId_returnsNil() {
        let url = URL(string: "molt://order")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }
    ...
    func test_parse_moltProfile_returnsProfile() {
    ...
    func test_parse_httpsProductUniversalLink_returnsProductDetail() {
        let url = URL(string: "https://molt.mt/product/prod_universal")!
        let route = DeepLinkParser.parse(url)
        #expect(route == .productDetail(productId: "prod_universal"))
    }

    @Test("https://molt.mt/product with missing id returns nil")
    func test_parse_httpsProductMissingId_returnsNil() {
        let url = URL(string: "https://molt.mt/product")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }
    ...
    func test_parse_httpsCategoryUniversalLink_returnsCategoryProducts() {
        let url = URL(string: "https://molt.mt/category/cat_electronics")!
        let route = DeepLinkParser.parse(url)
    ...
    func test_parse_httpsCategoryMissingId_returnsNil() {
        let url = URL(string: "https://molt.mt/category")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }
    ...
    func test_parse_moltUnknownHost_returnsNil() {
    ...
    func test_parse_httpsUnknownPath_returnsNil() {
        let url = URL(string: "https://molt.mt/unknownroute/123")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }

    @Test("https://molt.mt/ with empty path returns nil")
    func test_parse_httpsEmptyPath_returnsNil() {
        let url = URL(string: "https://molt.mt/")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }

    @Test("different https host returns nil")
    func test_parse_httpsDifferentHost_returnsNil() {
    ...
    func test_parse_httpScheme_returnsNil() {
        let url = URL(string: "http://molt.mt/product/123")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }

    @Test("ftp scheme returns nil")
    func test_parse_ftpScheme_returnsNil() {
        let url = URL(string: "ftp://molt.mt/product/123")!
        let route = DeepLinkParser.parse(url)
        #expect(route == nil)
    }
    ...
    func test_parse_moltProductEmptyId_returnsNil() {
        ...
        if let r = route, case .productDetail(let id) = r {
    ...
    func test_parse_moltOrderEmptyId_returnsNil() {
        ...
        let route = DeepLinkParser.parse(url)
        if let r = route, case .orderDetail(let id) = r {
    ...
    func test_parse_moltCategoryEmptyId_returnsNil() {
        ...
        let route = DeepLinkParser.parse(url)
        if let r = route, case .categoryProducts(let id, _) = r {
    ...
    func test_parse_moltOrder_routeRequiresAuth() {
        let url = URL(string: "molt://order/ord_secure")!
        let route = DeepLinkParser.parse(url)
        #expect(route?.requiresAuth == true)
    }

    @Test("molt://product/{id} resolves to productDetail which does not requiresAuth")
    func test_parse_moltProduct_routeDoesNotRequireAuth() {
        let url = URL(string: "molt://product/prod_public")!
        let route = DeepLinkParser.parse(url)
        #expect(route?.requiresAuth == false)
    }

    @Test("molt://cart resolves to cart which does not requiresAuth")
    func test_parse_moltCart_routeDoesNotRequireAuth() {
        let url = URL(string: "molt://cart")!
        let route = DeepLinkParser.parse(url)
        #expect(route?.requiresAuth == false)
    }
    ...
    func test_parse_moltProfile_routeDoesNotRequireAuth() {
        let url = URL(string: "molt://profile")!
        let route = DeepLinkParser.parse(url)
        #expect(route?.requiresAuth == false)
    }
    ...
    func test_parse_httpsProduct_routeDoesNotRequireAuth() {
        let url = URL(string: "https://molt.mt/product/prod_pub")!
        let route = DeepLinkParser.parse(url)
        #expect(route?.requiresAuth == false)
    }

    @Test("https://molt.mt/category/{id} resolves to route that does not requiresAuth")
    func test_parse_httpsCategory_routeDoesNotRequireAuth() {
        let url = URL(string: "https://molt.mt/category/cat_pub")!
        let route = DeepLinkParser.parse(url)
        #expect(route?.requiresAuth == false)
    }
    ...
    func test_parse_moltProductExtraSegments_parsesFirstSegment() {
        let url = URL(string: "molt://product/prod_main/extra")!
        let route = DeepLinkParser.parse(url)
