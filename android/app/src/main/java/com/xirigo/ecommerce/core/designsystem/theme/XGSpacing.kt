...
object XGSpacing {
    ...
    val MD = 12.dp // spacing.md
    val Base = 16.dp // spacing.base
    val LG = 20.dp // spacing.lg
    val XL = 24.dp // spacing.xl
    ...
    val ListItemSpacing = 10.dp // layout.listItemSpacing
    val SectionSpacing = 24.dp // layout.sectionSpacing
    val ProductGridSpacing = 10.dp // layout.productGrid.gutter
    val MinTouchTarget = 48.dp // layout.minTouchTarget
}
