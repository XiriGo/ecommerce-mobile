...
import com.xirigo.ecommerce.core.auth.dto.AuthTokenResponse
import com.xirigo.ecommerce.core.network.TokenProvider

/**
 * Tests for the DI-wiring contracts defined in [com.xirigo.ecommerce.core.auth.di.AuthModule].
 *
...
class AuthModuleTest {
    ...
    /**
     * Builds a [TokenProvider] that mirrors the [com.xirigo.ecommerce.core.auth.di.AuthProvidesModule]
